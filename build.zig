...
pub fn build(b: *std.Build) !void {
    ...
    // update-mesa step
    const gen_step = b.addSystemCommand(&.{ "bash", "scripts/generate-mesa.sh" });
...
const c_nir = [_][]const u8{
    ...
    m ++ "/src/compiler/nir/nir_clip_cull_distance_io_utils.c",
    m ++ "/src/compiler/nir/nir_clone.c",
    m ++ "/src/compiler/nir/nir_control_flow.c",
    m ++ "/src/compiler/nir/nir_convert_address_format.c",
    m ++ "/src/compiler/nir/nir_deref.c",
    m ++ "/src/compiler/nir/nir_divergence_analysis.c",
    m ++ "/src/compiler/nir/nir_dominance.c",
    m ++ "/src/compiler/nir/nir_dominance_lca.c",
    m ++ "/src/compiler/nir/nir_downgrade_pls_vars.c",
    m ++ "/src/compiler/nir/nir_fixup_is_exported.c",
    ...
    m ++ "/src/compiler/nir/nir_gather_output_deps.c",
    ...
    m ++ "/src/compiler/nir/nir_inline_sysval.c",
    m ++ "/src/compiler/nir/nir_inline_uniforms.c",
    m ++ "/src/compiler/nir/nir_instr_set.c",
    m ++ "/src/compiler/nir/nir_io_add_xfb_info.c",
    ...
    m ++ "/src/compiler/nir/nir_lower_abort.c",
    m ++ "/src/compiler/nir/nir_lower_alpha.c",
    ...
    m ++ "/src/compiler/nir/nir_lower_calls_to_builtins.c",
    ...
    m ++ "/src/compiler/nir/nir_lower_halt_to_return.c",
    ...
    m ++ "/src/compiler/nir/nir_lower_indirect_derefs_to_if_else_trees.c",
    ...
    m ++ "/src/compiler/nir/nir_lower_io_array_vars_to_elements.c",
    m ++ "/src/compiler/nir/nir_lower_io_indirect_loads.c",
    m ++ "/src/compiler/nir/nir_lower_io_to_scalar.c",
    m ++ "/src/compiler/nir/nir_lower_io_vars_to_scalar.c",
    m ++ "/src/compiler/nir/nir_lower_io_vars_to_temporaries.c",
    ...
    m ++ "/src/compiler/nir/nir_lower_sample_shading.c",
    m ++ "/src/compiler/nir/nir_lower_samplers.c",
    m ++ "/src/compiler/nir/nir_lower_scratch.c",
    m ++ "/src/compiler/nir/nir_lower_scratch_to_var.c",
    ...
    m ++ "/src/compiler/nir/nir_lower_workgroup_size.c",
    ...
    m ++ "/src/compiler/nir/nir_move_output_stores_to_end.c",
    m ++ "/src/compiler/nir/nir_move_vec_src_uses_to_dest.c",
    m ++ "/src/compiler/nir/nir_normalize_cubemap_coords.c",
    m ++ "/src/compiler/nir/nir_normalize_sin_cos.c",
    m ++ "/src/compiler/nir/nir_opt_access.c",
    m ++ "/src/compiler/nir/nir_opt_barriers.c",
    m ++ "/src/compiler/nir/nir_opt_barycentric.c",
    m ++ "/src/compiler/nir/nir_opt_call.c",
    m ++ "/src/compiler/nir/nir_opt_clip_cull_const.c",
    ...
    m ++ "/src/compiler/nir/nir_opt_fp_math_ctrl.c",
    ...
    m ++ "/src/compiler/nir/nir_opt_group_loads.c",
    ...
    m ++ "/src/compiler/nir/nir_opt_load_skip_helpers.c",
    ...
    m ++ "/src/compiler/nir/nir_opt_move_to_top.c",
    ...
    m ++ "/src/compiler/nir/nir_opt_phi_to_bool.c",
    m ++ "/src/compiler/nir/nir_opt_preamble.c",
    m ++ "/src/compiler/nir/nir_opt_ray_queries.c",
    m ++ "/src/compiler/nir/nir_opt_reassociate.c",
    ...
    m ++ "/src/compiler/nir/nir_opt_shared_vars_to_subgroup.c",
    ...
    m ++ "/src/compiler/nir/nir_recompute_io_bases.c",
    m ++ "/src/compiler/nir/nir_remove_outputs.c",
    ...
    m ++ "/src/compiler/nir/nir_separate_merged_clip_cull_io.c",
    m ++ "/src/compiler/nir/nir_serialize.c",
    m ++ "/src/compiler/nir/nir_shader_bisect.c",
    m ++ "/src/compiler/nir/nir_split_64bit_vec3_and_vec4.c",
    m ++ "/src/compiler/nir/nir_split_conversions.c",
